...
MACHINE LEARNING:-
STEPS:-
1. DATA LEARNING:- Data collection, Data preprocessing, Feature engineering, Model training, Model evaluation, Iterative learning.
2. DECISION MAKING:- Making choices using probabilities, setting rules, adapting to new information, learning from mistakes.
